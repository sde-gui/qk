...
G_DEFINE_TYPE (FooCanvasItem, foo_canvas_item, GTK_TYPE_OBJECT)
...
G_DEFINE_TYPE (FooCanvasGroup, foo_canvas_group, FOO_TYPE_CANVAS_ITEM)
...
foo_canvas_destroy (GtkObject *object)
{
	...
	if (GTK_OBJECT_CLASS (foo_canvas_parent_class)->destroy)
		GTK_OBJECT_CLASS (foo_canvas_parent_class)->destroy (object);
}
...
foo_canvas_map (GtkWidget *widget)
{
	...
	if (GTK_WIDGET_CLASS (foo_canvas_parent_class)->map)
		GTK_WIDGET_CLASS (foo_canvas_parent_class)->map (widget);
...
foo_canvas_unmap (GtkWidget *widget)
{
	...
	if (GTK_WIDGET_CLASS (foo_canvas_parent_class)->unmap)
		GTK_WIDGET_CLASS (foo_canvas_parent_class)->unmap (widget);
}
...
foo_canvas_realize (GtkWidget *widget)
{
	...
	if (GTK_WIDGET_CLASS (foo_canvas_parent_class)->realize)
		GTK_WIDGET_CLASS (foo_canvas_parent_class)->realize (widget);
...
foo_canvas_unrealize (GtkWidget *widget)
{
	...
	if (GTK_WIDGET_CLASS (foo_canvas_parent_class)->unrealize)
		GTK_WIDGET_CLASS (foo_canvas_parent_class)->unrealize (widget);
}
...
foo_canvas_size_allocate (GtkWidget *widget, GtkAllocation *allocation)
{
	...
	if (GTK_WIDGET_CLASS (foo_canvas_parent_class)->size_allocate)
		GTK_WIDGET_CLASS (foo_canvas_parent_class)->size_allocate (widget, allocation);
...
foo_canvas_key (GtkWidget *widget, GdkEventKey *event)
{
	...
	if (event->type == GDK_KEY_RELEASE)
		return GTK_WIDGET_CLASS (foo_canvas_parent_class)->key_release_event (widget, event);
	else
		return GTK_WIDGET_CLASS (foo_canvas_parent_class)->key_press_event (widget, event);
}
...
foo_canvas_expose (GtkWidget *widget, GdkEventExpose *event)
{
	...
	GTK_WIDGET_CLASS (foo_canvas_parent_class)->expose_event (widget, event);
