...
foo_canvas_text_destroy (GtkObject *object)
{
	...
	if (GTK_OBJECT_CLASS (foo_canvas_text_parent_class)->destroy)
		GTK_OBJECT_CLASS (foo_canvas_text_parent_class)->destroy (object);
}
...
foo_canvas_text_update (FooCanvasItem *item, double i2w_dx, double i2w_dy, FooCanvasUpdateFlags flags)
{
	...
	if (FOO_CANVAS_ITEM_CLASS (foo_canvas_text_parent_class)->update)
		FOO_CANVAS_ITEM_CLASS (foo_canvas_text_parent_class)->update (item, i2w_dx, i2w_dy, flags);
...
foo_canvas_text_realize (FooCanvasItem *item)
{
	...
	if (FOO_CANVAS_ITEM_CLASS (foo_canvas_text_parent_class)->realize)
		FOO_CANVAS_ITEM_CLASS (foo_canvas_text_parent_class)->realize (item);
...
foo_canvas_text_unrealize (FooCanvasItem *item)
{
	...
	if (FOO_CANVAS_ITEM_CLASS (foo_canvas_text_parent_class)->unrealize)
		FOO_CANVAS_ITEM_CLASS (foo_canvas_text_parent_class)->unrealize (item);
}
