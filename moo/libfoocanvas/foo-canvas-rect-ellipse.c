...
G_DEFINE_TYPE(FooCanvasRE, foo_canvas_re, FOO_TYPE_CANVAS_ITEM)
G_DEFINE_TYPE(FooCanvasRect, foo_canvas_rect, FOO_TYPE_CANVAS_RE)
G_DEFINE_TYPE(FooCanvasEllipse, foo_canvas_ellipse, FOO_TYPE_CANVAS_RE)
...
foo_canvas_re_destroy (GtkObject *object)
{
	...
	if (GTK_OBJECT_CLASS (foo_canvas_re_parent_class)->destroy)
		GTK_OBJECT_CLASS (foo_canvas_re_parent_class)->destroy (object);
}
...
foo_canvas_re_update_shared (FooCanvasItem *item, double i2w_dx, double i2w_dy, int flags)
{
	...
	if (FOO_CANVAS_ITEM_CLASS (foo_canvas_re_parent_class)->update)
		FOO_CANVAS_ITEM_CLASS (foo_canvas_re_parent_class)->update (item, i2w_dx, i2w_dy, flags);
...
foo_canvas_re_realize (FooCanvasItem *item)
{
	...
	if (FOO_CANVAS_ITEM_CLASS (foo_canvas_re_parent_class)->realize)
		FOO_CANVAS_ITEM_CLASS (foo_canvas_re_parent_class)->realize (item);
...
foo_canvas_re_unrealize (FooCanvasItem *item)
{
	...
	if (FOO_CANVAS_ITEM_CLASS (foo_canvas_re_parent_class)->unrealize)
		FOO_CANVAS_ITEM_CLASS (foo_canvas_re_parent_class)->unrealize (item);
}
...
foo_canvas_rect_finalize (GObject *object)
{
	...
	G_OBJECT_CLASS (foo_canvas_rect_parent_class)->finalize (object);
}
...
foo_canvas_rect_realize  (FooCanvasItem *item)
{
	...
	if (FOO_CANVAS_ITEM_CLASS (foo_canvas_rect_parent_class)->realize)
		FOO_CANVAS_ITEM_CLASS (foo_canvas_rect_parent_class)->realize (item);
}
...
static void
foo_canvas_ellipse_init (G_GNUC_UNUSED FooCanvasEllipse *ellipse)
{
}
