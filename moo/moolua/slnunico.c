...
#if defined(SLNUNICODE_UTF8_AS_STRING) && defined(SLNUNICODE_AS_STRING)
#error SLNUNICODE_UTF8_AS_STRING and SLNUNICODE_AS_STRING may not be used together
#endif

#if (defined( SLNUNICODE_AS_STRING ) || defined( SLNUNICODE_UTF8_AS_STRING )) && defined( STRING_WITH_METAT )
