...
static GObject *
g_themed_icon_constructor (GType                  type,
                           ...
                           GObjectConstructParam *construct_properties)
{
  ...
  object = G_OBJECT_CLASS (g_themed_icon_parent_class)->
    constructor (type, n_construct_properties, construct_properties);
  themed = G_THEMED_ICON (object);

  g_return_val_if_fail (themed->names != NULL && themed->names[0] != NULL, object);
...
g_themed_icon_class_init (GThemedIconClass *klass)
{
  ...
  gobject_class->constructor = g_themed_icon_constructor;
