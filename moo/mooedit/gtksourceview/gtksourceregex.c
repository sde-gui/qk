 ...
 * Sep 08 2005: added implementation using pcre library (eggregex);
 *              made GtkSourceRegex ref-countable
 */

#ifdef DONT_WANT_PCRE_FOR_SOME_REASON
...
#else /* !DONT_WANT_PCRE_FOR_SOME_REASON */
...
GtkSourceRegex*
gtk_source_regex_compile (const char *pattern)
{
	GtkSourceRegex *regex;
	GError *error = NULL;
...
#endif /* !DONT_WANT_PCRE_FOR_SOME_REASON */
