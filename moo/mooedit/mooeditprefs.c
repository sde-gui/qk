...
void        _moo_edit_set_default_settings      (void)
{
    ...
    NEW_KEY_BOOL (MOO_EDIT_MATCHING_BRACKETS_CORRECT "/" MOO_EDIT_PREFS_BOLD, FALSE);
    NEW_KEY_BOOL (MOO_EDIT_MATCHING_BRACKETS_CORRECT "/" MOO_EDIT_PREFS_ITALIC, FALSE);
    NEW_KEY_BOOL (MOO_EDIT_MATCHING_BRACKETS_CORRECT "/" MOO_EDIT_PREFS_UNDERLINE, FALSE);
    NEW_KEY_BOOL (MOO_EDIT_MATCHING_BRACKETS_CORRECT "/" MOO_EDIT_PREFS_STRIKETHROUGH, FALSE);
    NEW_KEY_BOOL (MOO_EDIT_MATCHING_BRACKETS_INCORRECT "/" MOO_EDIT_PREFS_BOLD, FALSE);
    NEW_KEY_BOOL (MOO_EDIT_MATCHING_BRACKETS_INCORRECT "/" MOO_EDIT_PREFS_ITALIC, FALSE);
    NEW_KEY_BOOL (MOO_EDIT_MATCHING_BRACKETS_INCORRECT "/" MOO_EDIT_PREFS_UNDERLINE, FALSE);
    NEW_KEY_BOOL (MOO_EDIT_MATCHING_BRACKETS_INCORRECT "/" MOO_EDIT_PREFS_STRIKETHROUGH, FALSE);
    ...
    NEW_KEY_COLOR (MOO_EDIT_MATCHING_BRACKETS_CORRECT "/" MOO_EDIT_PREFS_FOREGROUND, &(style->base[GTK_STATE_SELECTED]));
    NEW_KEY_COLOR (MOO_EDIT_MATCHING_BRACKETS_INCORRECT "/" MOO_EDIT_PREFS_FOREGROUND, &(style->base[GTK_STATE_SELECTED]));
