...
IF(WIN32)
  ...
  SET(_MEDIT_PYTHON_DFLT)
  IF(MOO_ENABLE_PYTHON)
    MOO_DEBUG(STATUS "Looking for python")
    FOREACH(_moo_python_dir ${CMAKE_SOURCE_DIR}/../python-dist)
      IF(IS_DIRECTORY ${_moo_python_dir})
        SET(_MEDIT_PYTHON_DFLT ${_moo_python_dir})
        BREAK()
      ENDIF(IS_DIRECTORY ${_moo_python_dir})
    ENDFOREACH(_moo_python_dir)
    MOO_DEBUG(STATUS "Found ${_MEDIT_PYTHON_DFLT}")
  ENDIF(MOO_ENABLE_PYTHON)
  SET(MEDIT_PYTHON_LIBRARIES ${_MEDIT_PYTHON_DFLT} CACHE PATH "Where Python is located")
  IF(MEDIT_PYTHON_LIBRARIES)
    INSTALL(DIRECTORY ${MEDIT_PYTHON_LIBRARIES}/ DESTINATION ".")
  ENDIF(MEDIT_PYTHON_LIBRARIES)
ENDIF(WIN32)
