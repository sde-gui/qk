...
MACRO(MOO_WRITE_CONFIG_H _moo_in_file _moo_out_file)
  ...
  IF(NOT EXISTS ${_moo_abs_in_file})
    MOO_ERROR("File ${_moo_abs_in_file} does not exist")
  ENDIF(NOT EXISTS ${_moo_abs_in_file})
...
SET(_MOO_KNOWN_PLATFORMS CYGWIN WIN32 DARWIN UNIX FREEBSD BSD LINUX)
...
MACRO(MOO_OPTION variable dfltval helpstring)
  ...
  IF(_moo_option_define AND ${variable})
    MOO_ADD_COMPILE_DEFINITIONS(-D${variable}=1)
